...
verified-by: Prathapan C approved this skill's assignment via `fileIndex.md` (§2, already resolved before NORMALIZE); confirmed by manual review, recorded in `HITL/bid-evaluation/Nilgiri_Infraprojects_Tender_Qualification_ILLUSTRATIVE_SAMPLE/manualValidate.md`
