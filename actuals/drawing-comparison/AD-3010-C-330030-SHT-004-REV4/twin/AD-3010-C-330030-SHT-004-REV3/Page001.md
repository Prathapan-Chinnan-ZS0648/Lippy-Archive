...
| MEMB-10 | Plan EL. 111.500 | midpoint column, exact grid row not yet confirmed (see `skills/drawing-comparison/PatternLog.md` Entry 4) | SW | UC203x203x46 (-120) | none | no weld/bolt count printed; REV4 adds (30N 10V) per text diff |
| MEMB-11 | Plan EL. 111.500 | midpoint column, exact grid row not yet confirmed (see `skills/drawing-comparison/PatternLog.md` Entry 4) | SW | UC203x203x46 (-120) | none | no weld/bolt count printed; REV4 adds (30N 10V) per text diff |
| MEMB-12 | Plan EL. 111.500 | midpoint column, exact grid row not yet confirmed (see `skills/drawing-comparison/PatternLog.md` Entry 4) | SW | UC203x203x46 (-120) | none | no weld/bolt count printed; REV4 adds (30N 10V) per text diff |
| CTRL-1 | Plan EL. 112.800 | Grid A ladder cage, column-2 node | MW / BW | UB356x171x51 / L80x80x8 (-50), "HANDRAIL (TYP.)" | Rev 3 clouds present, triangle "3" | UNCHANGED control case; clouds cleared and labels reordered in REV4, see `skills/drawing-comparison/Skill.md` Module 6, "reformat control case". This node also carries MEMB-13/MEMB-14 — a real, adjacent change missed on first pass, see `prompt-log/drawing-comparison/PromptLog.md`'s 2026-09-17 correction entry |
...
| MEMB-13 | Plan EL. 112.800 | Grid A ladder cage (LADDER-1/2), upper dimension | — | 420 | Rev 3 cloud (not this pack's subject revision) | becomes 500 in REV4; added 2026-09-17, see `prompt-log/drawing-comparison/PromptLog.md`'s 2026-09-17 correction entry |
| MEMB-14 | Plan EL. 112.800 | Grid A ladder cage (LADDER-1/2), lower dimension | — | 545 | same cloud as MEMB-13 | becomes 515 in REV4; added 2026-09-17 |
| MEMB-15 | Plan EL. 112.800 | Grid E ladder cage (LADDER-3/4), upper dimension | — | 420 | Rev 3 cloud | becomes 500 in REV4; second occurrence of MEMB-13's pattern, added 2026-09-17 |
| MEMB-16 | Plan EL. 112.800 | Grid E ladder cage (LADDER-3/4), lower dimension | — | 545 | same cloud as MEMB-15 | becomes 515 in REV4; added 2026-09-17 |
| CTRL-3 | Plan EL. 112.800 | Grid E ladder cage, column-2 node | MW / BW | UB356x171x51 / L80x80x8 (-50), "HANDRAIL (TYP.)" | Rev 3 clouds present, triangle "3" | UNCHANGED control case mirroring CTRL-1; added 2026-09-17 |
