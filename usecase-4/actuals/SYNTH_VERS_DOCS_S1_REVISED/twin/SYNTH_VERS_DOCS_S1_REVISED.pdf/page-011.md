...
Vendors must complete the following pricing form in full. Unit prices must be all-inclusive of labor, materials, travel, and overhead unless otherwise noted.
...
Provide at least 5 references meeting the eligibility criteria in Section 7, including at least 2 involving cold chain/refrigerated logistics. Duplicate this table as needed.
...
| Included Cold Chain Monitoring? (Y/N) |  |
| Contract Value |  |
| Completion Date |  |
