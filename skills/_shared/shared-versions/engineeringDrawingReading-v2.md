...
version: 2
status: current — live copy; snapshot preserved at skills/_shared/shared-versions/engineeringDrawingReading-v2.md
supersedes: v1.md (see skills/_shared/shared-versions/ for immutable history)
