...
version: 2
status: current — live copy; snapshot preserved at skills/drawing-comparison/skill-versions/v2.md
supersedes: v1.md (see skills/drawing-comparison/skill-versions/ for immutable history)
