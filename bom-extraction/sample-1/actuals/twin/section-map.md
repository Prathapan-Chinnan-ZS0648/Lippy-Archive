...
`260374 COMBINED PID SET 6-1-26.pdf`, 13 pages, single document (no supporting/superseded revision for this skill — see `bootstrap.md`). Page order in the file does **not** track drawing-number order; see `pivot.md` § 2.
...
| 13 | D-260374-11-004 | intentionally blank (out of numeric sequence — see pivot.md § 2) |
